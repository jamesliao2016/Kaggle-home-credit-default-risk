...
if __name__ == '__main__':
    ...
    for tries in range(ntries):
        print('Generating submission with '+str(tries)+'th tries ...')
        used_seed=orig_seed+tries
        folds = KFold(n_splits=5, shuffle=True, random_state=used_seed)
        ...
        if platform.system() == 'Linux':
            ...
            mysys='MacOSX'
        filename='first_submission_'+mysys+'_seed'+str(used_seed)+'.csv'
